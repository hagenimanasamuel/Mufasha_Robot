...
export default function ChatUI() {
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col">
      ...
      {!textChat && ( <div className="flex-grow flex justify-center items-center mt-[9.3vh]">
        <div
          ...
          {!isRecording && (
            <>
              ...
              >
                ...
                <p className="text-white mx-2">Start Mufasha <sup>AI</sup></p>
              </button>
            </>
          )}
          {isRecording && (
            <>
              <div className="relative flex justify-between align-items-center text-white w-full h-full bg-gray-900 rounded-md p-4">
                <div className="relative flex flex-column justify-center align-content-center text-blue-300">
                  ...
                  <p className="flex justify-center text-[18px] mr-8">Listening...</p>
                </div>
